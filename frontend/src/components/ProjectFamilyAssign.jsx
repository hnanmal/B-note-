    ...
    >
      ...
      >
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
            justifyContent: collapsedColumns.left ? 'center' : 'space-between',
            width: '100%',
          }}
        >
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            {collapsedColumns.middle ? '가운데 열 펼치기' : '가운데 열 접기'}
          </button>
        </div>
        {!collapsedColumns.middle && (
          <>
            <div
              style={{
                display: 'flex',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                >
                  {collapsedPanels.building ? '펼치기' : '접기'}
                </button>
              </div>
              {!collapsedPanels.building && (
                <select
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                >
                  {collapsedPanels.revit ? '펼치기' : '접기'}
                </button>
              </div>
              {!collapsedPanels.revit && (
                <>
                  <textarea
                    rows={3}
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          ...
          >
            {collapsedColumns.right ? '오른쪽 열 펼치기' : '오른쪽 열 접기'}
          </button>
        </div>
        {!collapsedColumns.right && (
          <>
            <div
              style={{
                display: 'flex',
            ...
            >
              <span>Work Master 메뉴</span>
              <button
                type="button"
                onClick={() => togglePanel('workMaster')}
                style={{
                  border: '1px solid #cbd5f5',
                  background: '#fff',
                  borderRadius: 8,
              ...
              >
                {collapsedPanels.workMaster ? '펼치기' : '접기'}
              </button>
            </div>
            {!collapsedPanels.workMaster && (
              <>
                <div
                  style={{
                    display: 'flex',
